...
# ================ #
dict_nu = {
    'acc': np.arange(0.06, 0.26, 0.01).round(2).tolist(),
    'gyr': np.arange(0.31, 0.51, 0.01).round(2).tolist(),
    'swp': np.arange(0.21, 0.41, 0.01).round(2).tolist(),
    'tap': np.arange(0.61, 0.8, 0.01).round(2).tolist()
}

dict_gamma = {
    'acc': np.arange(0.01, 0.11, 0.005).round(3).tolist(),
    'gyr': np.arange(0.04, 0.24, 0.01).round(2).tolist(),
    'swp': np.arange(0.06, 0.26, 0.01).round(2).tolist(),
