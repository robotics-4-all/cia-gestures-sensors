...
# ================ #
dict_nu = {
    'acc': np.arange(0.001, 0.06, 0.003).round(3).tolist(),
    'gyr': np.arange(0.11, 0.31, 0.01).round(2).tolist(),
    'swp': np.arange(0.01, 0.21, 0.01).round(2).tolist(),
    'tap': np.arange(0.02, 0.6, 0.03).round(2).tolist()
}

dict_gamma = {
    'acc': np.arange(0.0001, 0.004, 0.0002).round(4).tolist(),
    'gyr': np.arange(0.001, 0.04, 0.002).round(3).tolist(),
    'swp': np.arange(0.001, 0.06, 0.003).round(3).tolist(),
