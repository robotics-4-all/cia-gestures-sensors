...
def Clf_GetPredictions(Decisions):
    """
    Use the decisions of samples to get their predictions.
    First calculate the total decision for a sample and then the prediction.

    :param Decisions: The decisions of samples.
    :return: The predictions and the total decisions
    """
