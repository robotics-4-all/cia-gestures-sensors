...
CreateTrnTstSets : This script contains functions in order split the dataset in original user's or atteckers, synced or not and train or test sets.
"""
...
# Split_Rate - The percentage of entries that the test set must contain
#--------------------------------------------------
def CreateFinalSets(FDF_Swipes, FDF_Acc, FDF_Gyr, Original_User, Split_Rate):
