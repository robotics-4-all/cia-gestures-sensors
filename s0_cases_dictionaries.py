...
dict_cases = {
    ...
    'case9': {
        ...
        'GetResults': {
            ...
            'Classifiers': {
                'acc': cases.case9.case_subclasses.AccClassifier,
                'gyr': cases.case9.case_subclasses.GyrClassifier,
                'swp': cases.case9.case_subclasses.SwpClassifier,
                'tap': cases.case9.case_subclasses.TapClassifier
            }
