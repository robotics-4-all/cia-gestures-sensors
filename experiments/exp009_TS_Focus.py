...
for idx_OrgU in range(len(DF_Users_Sensrors)):
    ...
    for Fold in tqdm(range(10), desc = '-> Fold'):
        ...
        """
        corr_Swipes = DFF_Swipes_Org_Trn_X.loc[:, Features_Swipes].corr()
        plt.figure(figsize=(8, 8))
        corrplot(corr_Swipes, size_scale=300)
        """
        ...
        for k in range(len(Clfs_Acc)):
            Predictions_Acc_Org_Tst = Clf_GetPredictions(Clfs_Acc[k], DFF_Acc_Org_Tst_X)
        ...
        for k in range(len(Clfs_Gyr)):
            Predictions_Gyr_Org_Tst = Clf_GetPredictions(Clfs_Gyr[k], DFF_Gyr_Org_Tst_X)
        ...
        for k in range(len(Clfs_Acc)):
            Predictions_Acc_Att = Clf_GetPredictions(Clfs_Acc[k], DFF_Acc_Att_X)
        ...
        for k in range(len(Clfs_Gyr)):
            Predictions_Gyr_Att = Clf_GetPredictions(Clfs_Gyr[k], DFF_Gyr_Att_X)
...
|        |   ize   |   ize   |   ize   |    y    |         |         |         |
+========+=========+=========+=========+=========+=========+=========+=========+
|  Acc   | 217.714 | 53.857  | 5431.42 | 79.201  | 17.047  | 20.963  | 6.855 % |
|        |         |         |    9    |    %    |    %    |    %    |         |
+--------+---------+---------+---------+---------+---------+---------+---------+
|  Gyr   | 217.714 | 53.857  | 5431.42 | 68.921  | 9.26 %  | 31.276  | 12.082  |
|        |         |         |    9    |    %    |         |    %    |    %    |
+--------+---------+---------+---------+---------+---------+---------+---------+
| Swipes | 320.286 | 79.524  | 7996.19 | 99.0 %  | 4.685 % | 0.03 %  | 97.329  |
|        |         |         |    0    |         |         |         |    %    |
+--------+---------+---------+---------+---------+---------+---------+---------+
"""
