...
+----------+-------------------+----------------+------------+---------------------+------------------+--------------------+-------------------+-------------------+-------------------+----------------+---------------------+
| 24 Users |    OrgTrnSize     |   OrgTstSize   |   AttNum   |    Att_TotalSize    |   Att_AvgSize    |        FRR         |     FRR_Conf      |     FAR_Total     |      FAR_Avg      | Num_Of_Unlocks | Num_Of_Accepted_Avg |
| Mathisis |                   |                |            |                     |                  |                    |                   |                   |                   |                |                     |
+==========+===================+================+============+=====================+==================+====================+===================+===================+===================+================+=====================+
|   Acc    | 248.792 (145.862) | 61.708 (36.51) | 23.0 (0.0) |  7141.5 (182.371)   |  310.5 (7.929)   | 7.143 % (2.616 %)  | 0.045 % (0.119 %) | 2.26 % (1.412 %)  | 2.217 % (1.422 %) | 0.017 (0.038)  |    1.547 (0.514)    |
+----------+-------------------+----------------+------------+---------------------+------------------+--------------------+-------------------+-------------------+-------------------+----------------+---------------------+
|   Gyr    | 248.792 (145.862) | 61.708 (36.51) | 23.0 (0.0) |  7141.5 (182.371)   |  310.5 (7.929)   | 6.154 % (2.788 %)  | 0.084 % (0.272 %) | 3.807 % (1.646 %) | 3.68 % (1.601 %)  | 0.025 (0.085)  |    2.438 (1.072)    |
+----------+-------------------+----------------+------------+---------------------+------------------+--------------------+-------------------+-------------------+-------------------+----------------+---------------------+
|  Swipes  | 361.167 (372.349) | 89.75 (93.03)  | 23.0 (0.0) | 10371.083 (465.379) | 450.917 (20.234) | 32.98 % (14.108 %) | 6.273 % (6.156 %) | 2.754 % (1.811 %) |  2.65 % (1.75 %)  |  2.317 (1.26)  |    1.798 (1.547)    |
+----------+-------------------+----------------+------------+---------------------+------------------+--------------------+-------------------+-------------------+-------------------+----------------+---------------------+
"""
