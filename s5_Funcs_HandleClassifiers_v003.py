...
def CalculateMeanMetrics(EvaluationMetrics_Folds, EvaluationMetrics):
    ...
    OrgTrnSize_Std = np.std(EvaluationMetrics_Folds.getOrgTrnSize())
    OrgTstSize_Std = np.std(EvaluationMetrics_Folds.getOrgTstSize())
    AttNum_Std = np.std(EvaluationMetrics_Folds.getAttNum())
    Att_TotalSize_Std = np.std(EvaluationMetrics_Folds.getAtt_TotalSize())
    Att_AvgSize_Std = np.std(EvaluationMetrics_Folds.getAtt_AvgSize())
    FRR_Std = np.std(EvaluationMetrics_Folds.getFRR())
    FRR_Conf_Std = np.std(EvaluationMetrics_Folds.getFRR_Conf())
    FAR_Total_Std = np.std(EvaluationMetrics_Folds.getFAR_Total())
    FAR_Avg_Std = np.std(EvaluationMetrics_Folds.getFAR_Avg())
    Num_Of_Unlocks_Std = np.std(EvaluationMetrics_Folds.getNum_Of_Unlocks())
    Num_Of_Accepted_Avg_Std = np.std(EvaluationMetrics_Folds.getNum_Of_Accepted_Avg())
