...
def Clf_GetPredictions(Decisions):
    ...
    For every decision make a prediction.
...
def Clf_GetTotalPredictions(Predictions):
    """
    User the predictions in order to make the total prediction.

    :param Predictions: The predeictions
    :return: The total prediction
    """
